 ...
 */
class ReactConsumer extends EventEmitter
{
    /**
     ...
     */
    public function __construct(MessageProviderInterface $messageProvider, LoopInterface $loop, $interval, $max = null)
    {
    ...
    public function __invoke()
    {
        ...
        $counter = 0;
        while ($envelope = $this->messageProvider->get()) {
            $this->emit('consume', [$envelope, $this->messageProvider]);
    ...
    {
        return call_user_func_array([$this->messageProvider, $method], $args);
    }
